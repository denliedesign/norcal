...
@section('content')
    ...
    <div class="my-5 text-white d-none d-md-block">
        <div class="row m-0 c-0">
            <div class="col-6 bg-light-gray pl-5 py-2">
                <div class="container">
                    <h1 class="text-uppercase" style="text-align: right;">norcal is a safer</h1>
    ...
    <div class="container">
        <h2 class="my-5 font-weight-bold text-uppercase">Cheer, Tumbling, & Hip Hop Classes For All Ages</h2>
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-5 mb-5">
            <div class="col px-2 pb-3">
                <div class="class-card-wrap border border-muted">
                    ...
                    <div class="class-card-content my-3">
                        <p class="m-0 text-center"><strong>Tots & Tinies</strong></p>
                        <hr>
            ...
            <div class="col px-2 pb-3">
                <div class="class-card-wrap border border-muted">
                    <img src="/images/norcal-classes.png" alt="" class="img-fluid" style="object-fit: cover; object-position: 15% 0;">
                    <div class="class-card-content my-3">
                        <p class="m-0 text-center"><strong>Cheer</strong></p>
                        <hr>
                        <div class="text-center">
            ...
            <div class="col px-2 pb-3">
                <div class="class-card-wrap border border-muted">
                    <img src="/images/norcal-classes.png" alt="" class="img-fluid" style="object-fit: cover; object-position: 15% 0;">
                    <div class="class-card-content my-3">
                        <p class="m-0 text-center"><strong>Hip Hop</strong></p>
                        <hr>
                        <div class="text-center">
            ...
            <div class="col px-2 pb-3">
                <div class="class-card-wrap border border-muted">
                    <img src="/images/norcal-classes.png" alt="" class="img-fluid" style="object-fit: cover; object-position: 15% 0;">
                    <div class="class-card-content my-3">
                        <p class="m-0 text-center"><strong>Theme</strong></p>
                        <hr>
                        <div class="text-center">
